...
from acrionai.rag.interface import RAGObject
...
class MilvusRetrieverConfig(IndexRetrieverConfig):
    ...
    collection_name: str = Field(default="acrionai", description="The name of the collection.")
...
class ElasticsearchStoreConfig(BaseModel):
    index_name: str = Field(default="acrionai", description="Name of the Elasticsearch index.")
