...
- 在 `~/.acrionai/config2.yaml / config/config2.yaml` 中配置您的 `api_key`
- 优先级顺序：`~/.acrionai/config2.yaml > config/config2.yaml`
...
acrionai "写一个命令行贪吃蛇" --code_review
```
