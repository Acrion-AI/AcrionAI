...
from acrionai.schema import CodingContext, Document, Documents, Message, TestingContext
from acrionai.utils.common import any_to_str
from tests.acrionai.serialize_deserialize.test_serdeser_base import (
    MockICMessage,
    MockMessage,
)
...
def test_message_serdeser_from_create_model():
    ...
    assert ser_data["cause_by"] == "acrionai.actions.write_code.WriteCode"
