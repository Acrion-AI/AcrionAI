...
- Configure your `api_key` in any of `~/.acrionai/config2.yaml / config/config2.yaml`
- Priority order: `~/.acrionai/config2.yaml > config/config2.yaml`
...
```shell
acrionai "Write a cli snake game based on pygame"
```

### Usage

```
 Usage: acrionai [OPTIONS] [IDEA]                                                                                                                                                                                          
...
│ --init-config                --no-init-config             Initialize the configuration file for AcrionAI. [default: no-init-config]                                                                                     │
