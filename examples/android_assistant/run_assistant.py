...
#           See the usage README inside `acrionai/ext/android_assistant`
#           README see `acrionai/ext/android_assistant/README.md`
...
from acrionai.ext.android_assistant.roles.android_assistant import AndroidAssistant
