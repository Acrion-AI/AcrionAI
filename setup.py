...
setup(
    ...
    url="https://github.com/Acrion-AI/AcrionAI",
    author="Alexander Wu",
    author_email="alexanderwu@acrion.ai",
    license="MIT",
    keywords="acrionai multi-agent multi-role programming gpt llm metaprogramming",
    ...
    entry_points={
        "console_scripts": [
            "acrionai=acrionai.software_company:app",
        ],
    },
