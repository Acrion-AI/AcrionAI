...
from acrionai.const import EXAMPLE_DATA_PATH
...
from acrionai.utils.omniparse_client import OmniParseClient
...
class TestOmniParseClient:
    ...
    def mock_request_parse(self, mocker):
        return mocker.patch("acrionai.rag.parsers.omniparse.OmniParseClient._request_parse")
