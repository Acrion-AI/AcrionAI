...
def get_acrionai_package_root():
    """Get the root directory of the installed package."""
    package_root = Path(acrionai.__file__).parent.parent
...
def get_acrionai_root():
    ...
    if project_root_env:
        ...
        project_root = get_acrionai_package_root()
    return project_root


# METAGPT PROJECT ROOT AND VARS
CONFIG_ROOT = Path.home() / ".acrionai"
METAGPT_ROOT = get_acrionai_root()  # Dependent on METAGPT_PROJECT_ROOT
...
SOURCE_ROOT = METAGPT_ROOT / "acrionai"
PROMPT_PATH = SOURCE_ROOT / "prompts"
SKILL_DIRECTORY = SOURCE_ROOT / "skills"
TOOL_SCHEMA_PATH = METAGPT_ROOT / "acrionai/tools/schemas"
TOOL_LIBS_PATH = METAGPT_ROOT / "acrionai/tools/libs"
