...
Attributes:
    ...
    METAGPT_ROOT (Path): Root path for AcrionAI files.
...
from acrionai.config2 import merge_dict
from acrionai.configs.llm_config import LLMConfig
...
class ModelsConfig(YamlModel):
    ...
    Methods:
        ...
        from_home(cls, path): Loads configuration from ~/.acrionai/config2.yaml.
    ...
    def from_home(cls, path):
        """
        Loads configuration from ~/.acrionai/config2.yaml.
