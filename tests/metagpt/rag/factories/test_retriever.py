...
from acrionai.rag.factories.retriever import RetrieverFactory
from acrionai.rag.retrievers.bm25_retriever import DynamicBM25Retriever
from acrionai.rag.retrievers.chroma_retriever import ChromaRetriever
from acrionai.rag.retrievers.es_retriever import ElasticsearchRetriever
from acrionai.rag.retrievers.faiss_retriever import FAISSRetriever
from acrionai.rag.retrievers.hybrid_retriever import SimpleHybridRetriever
from acrionai.rag.retrievers.milvus_retriever import MilvusRetriever
from acrionai.rag.schema import (
    BM25RetrieverConfig,
...
class TestRetrieverFactory:
    ...
    def test_get_retriever_with_chroma_config(self, mocker, mock_chroma_vector_store, mock_embedding):
        ...
        mock_chromadb = mocker.patch("acrionai.rag.factories.retriever.chromadb.PersistentClient")
        mock_chromadb.get_or_create_collection.return_value = mocker.MagicMock()
        mocker.patch("acrionai.rag.factories.retriever.ChromaVectorStore", return_value=mock_chroma_vector_store)
    ...
    def test_get_retriever_with_milvus_config(self, mocker, mock_milvus_vector_store, mock_embedding):
        ...
        mocker.patch("acrionai.rag.factories.retriever.MilvusVectorStore", return_value=mock_milvus_vector_store)
    ...
    def test_get_retriever_with_es_config(self, mocker, mock_es_vector_store, mock_embedding):
        ...
        mocker.patch("acrionai.rag.factories.retriever.ElasticsearchStore", return_value=mock_es_vector_store)
