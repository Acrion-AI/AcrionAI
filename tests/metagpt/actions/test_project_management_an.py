...
from acrionai.actions.action_node import ActionNode, dict_to_markdown
from acrionai.actions.project_management import NEW_REQ_TEMPLATE
from acrionai.actions.project_management_an import PM_NODE, REFINED_PM_NODE
...
from tests.acrionai.actions.mock_json import TASK
...
async def test_project_management_an(mocker):
    ...
    mocker.patch("acrionai.actions.project_management_an.PM_NODE.fill", return_value=root)
...
async def test_project_management_an_inc(mocker):
    ...
    mocker.patch("acrionai.actions.project_management_an.REFINED_PM_NODE.fill", return_value=root)
