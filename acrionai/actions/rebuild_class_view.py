...
from acrionai.repo_parser import DotClassInfo, RepoParser
from acrionai.schema import UMLClassView
from acrionai.utils.common import concat_namespace, split_namespace
from acrionai.utils.di_graph_repository import DiGraphRepository
from acrionai.utils.graph_repository import GraphKeyword, GraphRepository
...
class RebuildClassView(Action):
    ...
    def _diff_path(path_root: Path, package_root: Path) -> (str, str):
        ...
        Example:
            >>> _diff_path(path_root=Path("/Users/x/github/AcrionAI"), package_root=Path("/Users/x/github/AcrionAI/acrionai"))
            "-", "acrionai"

            >>> _diff_path(path_root=Path("/Users/x/github/AcrionAI/acrionai"), package_root=Path("/Users/x/github/AcrionAI/acrionai"))
            "=", "."
        """
    ...
    def _align_root(path: str, direction: str, diff_path: str) -> str:
        ...
        Example:
            >>> _align_root(path="acrionai/software_company.py", direction="+", diff_path="AcrionAI")
            "AcrionAI/acrionai/software_company.py"
