...
from acrionai.ext.aflow.data.download_data import download
from acrionai.ext.aflow.scripts.optimizer import Optimizer
...
def parse_args():
    ...
    parser.add_argument(
        "--optimized_path",
        type=str,
        default="acrionai/ext/aflow/scripts/optimized",
