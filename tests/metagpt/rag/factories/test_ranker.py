...
from acrionai.rag.factories.ranker import RankerFactory
from acrionai.rag.schema import ColbertRerankConfig, LLMRankerConfig, ObjectRankerConfig
...
class TestRankerFactory:
    ...
    def test_create_object_ranker(self, mocker, mock_llm):
        mocker.patch("acrionai.rag.factories.ranker.ObjectSortPostprocessor", return_value="object")
