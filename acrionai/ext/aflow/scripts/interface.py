...
from acrionai.configs.models_config import ModelsConfig
...
def load_best_round(dataset: str, optimized_path: str = "acrionai/ext/aflow/scripts/optimized") -> int:
    """加载最佳表现的轮次"""
...
async def aflow_inference(
    ...
    optimized_path: str = "acrionai/ext/aflow/scripts/optimized",
) -> Tuple[str, float]:
    """AFLOW推理接口
