...
from acrionai import logs
from acrionai.const import METAGPT_ROOT
from acrionai.tools.libs.gpt_v_generator import GPTvGenerator
...
```css\n/* styles.css */\n```\n
```javascript\n// scripts.js\n```\n"""
    mocker.patch("acrionai.provider.base_llm.BaseLLM.aask", return_value=mock_data)
    return mocker
...
def mock_image_layout(mocker):
    ...
    mocker.patch("acrionai.provider.base_llm.BaseLLM.aask", return_value=image_layout)
    return mocker
