...
from acrionai.actions.write_code_plan_and_change_an import (
    REFINED_TEMPLATE,
    WriteCodePlanAndChange,
)
from acrionai.logs import logger
from acrionai.schema import CodePlanAndChangeContext
...
from tests.acrionai.actions.test_write_code import setup_inc_workdir
...
async def test_write_code_plan_and_change_an(mocker, context, git_dir):
    ...
    mocker.patch(
        "acrionai.actions.write_code_plan_and_change_an.WRITE_CODE_PLAN_AND_CHANGE_NODE.fill", return_value=root
    )
