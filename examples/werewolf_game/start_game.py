...
from acrionai.ext.werewolf.roles import Guard, Moderator, Seer, Villager, Werewolf, Witch
from acrionai.ext.werewolf.roles.human_player import prepare_human_player
from acrionai.ext.werewolf.werewolf_game import WerewolfGame
