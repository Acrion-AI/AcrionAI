...
from acrionai.utils.async_helper import NestAsyncio
from acrionai.utils.token_counter import TOKEN_MAX


class RAGLLM(CustomLLM):
    """LlamaIndex's LLM is different from AcrionAI's LLM.

    Inherit CustomLLM from llamaindex, making AcrionAI's LLM can be used by LlamaIndex.
    ...
    model_infer: BaseLLM = Field(..., description="The AcrionAI's LLM.")
