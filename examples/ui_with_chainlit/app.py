...
async def chat_profile() -> list[cl.ChatProfile]:
    """Generates a chat profile containing starter messages which can be triggered to run AcrionAI
    ...
    return [
        cl.ChatProfile(
            name="AcrionAI",
            icon="/public/AcrionAI-new-log.jpg",
...
async def startup(message: cl.Message) -> None:
    """On Message in UI, Create a AcrionAI software company
