...
from acrionai.learn.skill_loader import Example, Parameter, Returns, Skill
...
class TestSkillAction:
    skill = Skill(
        ...
        x_prerequisite={
            "configurations": {
                ...
                "acrionai_tti_url": {"type": "string", "description": "Model url."},
            },
            "required": {"oneOf": ["OPENAI_API_KEY", "acrionai_tti_url"]},
        },
        parameters={
    ...
    async def test_parser_action(self, mocker, context):
        # mock
        mocker.patch("acrionai.learn.text_to_image", return_value="https://mock.com/xxx")
