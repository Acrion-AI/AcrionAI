...
# -*- coding: utf-8 -*-
"""
@Desc   : unittest of `acrionai/memory/longterm_memory.py`
"""


import pytest

from acrionai.actions import UserRequirement
from acrionai.memory.longterm_memory import LongTermMemory
from acrionai.roles.role import RoleContext
from acrionai.schema import Message
from tests.acrionai.memory.mock_text_embed import (
...
async def test_ltm_search(mocker):
    ...
    rc = RoleContext(watch={"acrionai.actions.add_requirement.UserRequirement"})
    ltm = LongTermMemory()
