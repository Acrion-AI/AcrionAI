...
from acrionai.logs import logger, set_llm_stream_logfunc
from acrionai.roles import Role
from acrionai.utils.common import any_to_name
...
class ChainlitEnv(Environment):
    ...
    async def _convert_message_to_markdownjson(self, message: str) -> str:
        """If the message is from AcrionAI Action Node output, then
