...
from acrionai.const import SYSTEM_DESIGN_FILE_REPO, TASK_FILE_REPO
...
def test_message_serdeser():
    ...
    assert message_dict["cause_by"] == "acrionai.actions.write_code.WriteCode"
    ...
    assert new_message.cause_by == "acrionai.actions.add_requirement.UserRequirement"
