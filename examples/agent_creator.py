"""
Filename: AcrionAI/examples/agent_creator.py
...
class CreateAgent(Action):
    PROMPT_TEMPLATE: str = """
    ### BACKGROUND
    You are using an agent framework called acrionai to write agents capable of different actions,
    the usage of acrionai can be illustrated by the following example:
