...
from acrionai.actions.action_node import ActionNode, ReviewMode, ReviseMode
...
async def test_debate_one_role():
    ...
    assert msg.sent_from == "acrionai.roles.role.Role"
...
async def test_action_node_with_image(mocker):
    ...
    mocker.patch("acrionai.provider.openai_api.OpenAILLM._cons_kwargs", _cons_kwargs)
