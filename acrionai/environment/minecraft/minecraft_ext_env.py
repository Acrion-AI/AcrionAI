...
from acrionai.environment.base_env import ExtEnv, mark_as_writeable
from acrionai.environment.base_env_space import BaseEnvAction, BaseEnvObsParams
from acrionai.environment.minecraft.const import (
    MC_CKPT_DIR,
...
from acrionai.environment.minecraft.process_monitor import SubprocessMonitor
    ...
    def _post_init_ext_env(self):
        if not self.mineflayer:
            self.mineflayer = SubprocessMonitor(
                commands=[
                    "node",
                    METAGPT_ROOT.joinpath("acrionai", "environment", "minecraft", "mineflayer", "index.js"),
