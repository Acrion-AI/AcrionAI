...
from acrionai.utils.common import awrite, check_cmd_exists
...
async def mermaid_to_file(engine, mermaid_code, output_file_without_suffix, width=2048, height=2048) -> int:
    ...
    if engine == "nodejs":
        ...
        if engine == "playwright":
            from acrionai.utils.mmdc_playwright import mermaid_to_file

            return await mermaid_to_file(mermaid_code, output_file_without_suffix, width, height)
        elif engine == "pyppeteer":
            from acrionai.utils.mmdc_pyppeteer import mermaid_to_file

            return await mermaid_to_file(mermaid_code, output_file_without_suffix, width, height)
        elif engine == "ink":
            from acrionai.utils.mmdc_ink import mermaid_to_file
