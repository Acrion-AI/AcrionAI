...
import acrionai
from acrionai.const import TEST_DATA_PATH
from acrionai.environment.android.android_env import AndroidEnv
from acrionai.ext.android_assistant.actions.manual_record import ManualRecord
from acrionai.ext.android_assistant.actions.parse_record import ParseRecord
from acrionai.ext.android_assistant.actions.screenshot_parse import ScreenshotParse
from acrionai.ext.android_assistant.actions.self_learn_and_reflect import (
    SelfLearnAndReflect,
)
from tests.acrionai.environment.android_env.test_android_ext_env import (
    mock_device_shape,
    mock_list_devices,
)
...
acrionai.environment.android.android_ext_env.AndroidExtEnv.execute_adb_with_cmd = mock_device_shape
acrionai.environment.android.android_ext_env.AndroidExtEnv.list_devices = mock_list_devices
