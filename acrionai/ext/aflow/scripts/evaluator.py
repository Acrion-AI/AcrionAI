...
from acrionai.ext.aflow.benchmark.drop import DROPBenchmark
from acrionai.ext.aflow.benchmark.gsm8k import GSM8KBenchmark
from acrionai.ext.aflow.benchmark.hotpotqa import HotpotQABenchmark
from acrionai.ext.aflow.benchmark.humaneval import HumanEvalBenchmark
from acrionai.ext.aflow.benchmark.math import MATHBenchmark
from acrionai.ext.aflow.benchmark.mbpp import MBPPBenchmark
...
class Evaluator:
    ...
    def _get_data_path(self, dataset: DatasetType, test: bool) -> str:
        base_path = f"acrionai/ext/aflow/data/{dataset.lower()}"
